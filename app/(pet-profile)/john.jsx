...
export default function JohnPetDetails() {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <TouchableOpacity style={styles.editIcon}>
          <Ionicons name="pencil" size={18} color="white" onPress={()=>router.push('(pet-details)/edit-john')}/>
        </TouchableOpacity>
        {/* Trash Icon */}
      ...
      <View style={styles.detailCard}>
        <Text style={styles.petName}>John's Detail</Text>
        <Text style={styles.label}>Gender</Text>
        <Text style={styles.info}>Female</Text>
        <Text style={styles.label}>Weight</Text>
        <Text style={styles.info}>5.2 Kg</Text>

        {/* Health Information */}
        <Text style={styles.healthHeader}>Health Information</Text>
        <Text style={styles.label}>Appointment</Text>
        <Text style={styles.info}>Dentistry</Text>
        <Text style={styles.label}>Date</Text>
        <Text style={styles.info}>16 August 2024</Text>
      </View>
