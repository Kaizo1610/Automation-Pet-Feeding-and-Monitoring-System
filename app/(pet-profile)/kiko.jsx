  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Image
          source={require('./../../assets/images/kiko.jpeg')} 
          style={styles.catImage}
        />
        {/* Edit (Pencil) Icon */}
        <TouchableOpacity style={styles.editIcon} onPress={()=>router.push('(pet-details)/edit-kiko')}>
      ...
      <View style={styles.detailCard}>
        <Text style={styles.petName}>Kiko's Detail</Text>
        <Text style={styles.label}>Gender</Text>
        <Text style={styles.info}>Male</Text>
        <Text style={styles.label}>Weight</Text>
        <Text style={styles.info}>3.6 Kg</Text>

        {/* Health Information */}
        <Text style={styles.healthHeader}>Health Information</Text>
        <Text style={styles.label}>Appointment</Text>
        <Text style={styles.info}>Dermatology</Text>
        <Text style={styles.label}>Date</Text>
        <Text style={styles.info}>25 July 2024</Text>
      </View>
